      ...
      <div style="position:sticky;top:120px;">
        ...
        if ( $stat1_num || $stat2_num ) : ?>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:32px;">
            <?php if ( $stat1_num ) : ?>
              <div style="padding:24px;background:var(--cream);border-left:3px solid var(--primary);">
                <div style="font-family:var(--font-header);font-size:2rem;font-weight:300;color:var(--secondary);line-height:1;letter-spacing:-0.02em;"><?php echo esc_html( $stat1_num ); ?></div>
                <div style="font-family:var(--font-mono);font-size:0.62rem;letter-spacing:0.2em;text-transform:uppercase;color:var(--secondary-lt);margin-top:6px;"><?php echo esc_html( $stat1_label ); ?></div>
              </div>
            <?php endif; ?>
            <?php if ( $stat2_num ) : ?>
              <div style="padding:24px;background:var(--cream);border-left:3px solid var(--primary);">
                <div style="font-family:var(--font-header);font-size:2rem;font-weight:300;color:var(--secondary);line-height:1;letter-spacing:-0.02em;"><?php echo esc_html( $stat2_num ); ?></div>
                <div style="font-family:var(--font-mono);font-size:0.62rem;letter-spacing:0.2em;text-transform:uppercase;color:var(--secondary-lt);margin-top:6px;"><?php echo esc_html( $stat2_label ); ?></div>
              </div>
            <?php endif; ?>
          </div>
        <?php endif; ?>
