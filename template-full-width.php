...
<div style="background:var(--white);padding:80px 0;">
  <div class="container" style="max-width:900px;">
    ...
    if ( $modified !== $published ) : ?>
      <div style="margin-top:60px;padding-top:32px;border-top:1px solid var(--rule);font-family:var(--font-mono);font-size:0.7rem;letter-spacing:0.15em;text-transform:uppercase;color:var(--slate-lt);">
