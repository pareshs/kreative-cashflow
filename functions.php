...
function kc_customizer( WP_Customize_Manager $wp_customize ) {
    ...
    // Stats
    kc_add_setting( $wp_customize, 'kc_stats_enable', '1', 'kc_stats', 'Enable Stats Section', 'checkbox' );
    ...
    // About stats
    for ( $i = 1; $i <= 4; $i++ ) {
        $defaults = [ '10+' => 'Years Experience', '500+' => 'Clients Helped', '50+' => 'Trusted Partners', '$2.4B' => 'Properties Settled' ];
